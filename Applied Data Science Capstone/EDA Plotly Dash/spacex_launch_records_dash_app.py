...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div(dcc.Graph(id='success_pie_chart', figure={})),
                                html.Br(),
                                
                                html.P("Payload range (kg):"),
                                # TASK 3: Add a slider to select payload range
                                dcc.RangeSlider(id='payload_slider',
                                                min= 0, max= 10000, step= 1500,
                                                value= [min_payload, max_payload]),
                                
                                # TASK 4: Add a scatter chart to show the correlation between payload and launch success
                                html.Div(dcc.Graph(id='success_payload_scatter_chart', figure={})),
...
def get_pie_chart(entered_site):   
    ...
    if entered_site == 'All':
        fig = px.pie(df, values = 'class',
                     labels= {'class':'Successful Launch Count'},
                     names = 'Launch Site', 
